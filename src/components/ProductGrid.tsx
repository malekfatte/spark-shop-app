...
const CATEGORIES = [
  ...
  { label: "Mats", keywords: ["mat"] },
  { label: "Wraps & Bags", keywords: ["wrap", "sleeping", "bag"] },
  { label: "Bulbs", keywords: ["bulb"] },
  { label: "Masks", keywords: ["mask"] },
  { label: "Devices", keywords: ["go2", "round", "foldable"] },
] as const;
