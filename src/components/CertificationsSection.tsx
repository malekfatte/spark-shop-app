      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
        ...
        >
          ...
          <p className="text-white/50 text-sm font-body font-light leading-relaxed">
            Every device passes rigorous third-party testing. Over <span className="text-lime font-normal">100 patents</span> protect our proprietary wavelength technology.
          </p>
        </motion.div>
        ...
        >
          {certifications.map((cert, i) => (
            ...
            >
              <cert.icon className="h-4 w-4 text-lime" />
              <div>
