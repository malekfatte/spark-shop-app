  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-14">
        <p className="text-red-300 font-heading font-medium tracking-[0.3em] uppercase text-xs mb-4">
          Professional Red Light Therapy
        </p>
        <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl font-bold leading-[1.1] mb-6 text-white">
          Heal Deeper.<br />
          <span className="text-gradient-red">Recover Faster.</span>
        </h1>
        <p className="text-gray-200 max-w-md mx-auto text-sm sm:text-base mb-8 leading-relaxed">
